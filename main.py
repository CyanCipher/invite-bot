...
reddit = praw.Reddit(
    ...
    client_secret=ids.SECRET_KEY,
    username="Dangerous-Hornet9878",
    password=ids.PASS,
    user_agent="SandeshVahak",
)
...
def visit_write(usrnm):
    with open("sent.csv", "a") as usr_list:
        usr_list.write(usrnm + "\n")


def main():
    with open("tobesent.csv", "r") as user_getter:
        csv_reader = csv.reader(user_getter)
